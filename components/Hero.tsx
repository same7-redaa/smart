        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 text-center lg:text-right mb-10 lg:mb-0">
            ...
            <p className="text-2xl md:text-3xl font-bold text-[#F59E0B] mb-4">
              للتسويق الإلكتروني والإنتاج الإعلامي
            </p>
            <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-xl mx-auto lg:mx-0">
              نساعد الشركات والمراكز الطبية والمتاجر والمطاعم على الوصول لعملاء أكثر وتحقيق نمو حقيقي وبناء براند قوي من خلال صناعة المحتوى والتسويق الإلكتروني.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <button
                onClick={scrollToServices}
                className="w-full sm:w-auto inline-block bg-[#F59E0B] hover:bg-[#EF8C00] text-white font-bold py-3 px-8 rounded-full transition-transform transform hover:scale-105 duration-300 shadow-lg focus:outline-none"
              >
                شاهد أعمالنا
              </button>
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20ba5a] text-white font-bold py-3 px-8 rounded-full transition-transform transform hover:scale-105 duration-300 shadow-lg focus:outline-none"
              >
